...
BLOG_AUTHOR = "YeOldeDM"  # (translatable)
...
# BASE_URL = "http://lets-godot-roguelike.netlify.com/"
BLOG_EMAIL = ""
BLOG_DESCRIPTION = "This is a series tutorial on how to make a roguelike in Godot."  # (translatable)
